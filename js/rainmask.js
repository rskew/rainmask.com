...
var _user$project$Update$init = function () {
	...
	var _p10 = _user$project$Slider$initialise(
		{name: 'Background Noise Level', value: 0.17, max: 1, min: 0, updateCommand: _user$project$Cmds$backgroundNoiseLevelPort, quant: false});
	var backgroundNoiseLevelSlider = _p10._0;
	var backgroundNoiseLevelInitCmd = _p10._1;
	var _p11 = _user$project$Slider$initialise(
		{name: 'Rain Intensity', value: 60, max: 200, min: 1, updateCommand: _user$project$Cmds$setTimerPort, quant: true});
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p13.ctor) {
			...
			default:
				var _p14 = A2(_user$project$Update$sliderUpdate, _p13._0, model.sliders);
				var updatedSliders = _p14._0;
				var slidersCmd = _p14._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
